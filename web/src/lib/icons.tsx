...
export const Smartphone = withId(Ph.DeviceMobileIcon, "Smartphone");
export const Dices = withId(Ph.DiceFiveIcon, "Dices");
export const DiscordLogo = withId(Ph.DiscordLogoIcon, "DiscordLogo");
export const Download = withId(Ph.DownloadIcon, "Download");
export const Mail = withId(Ph.EnvelopeIcon, "Mail");
...
export const Pages = withId(Ph.FilesIcon, "Pages");
...
export const InfiniteScroll = withId(Ph.InfinityIcon, "InfiniteScroll");
...
export const Link = withId(Ph.LinkIcon, "Link");
export const ListChecks = withId(Ph.ListChecksIcon, "ListChecks");
...
export const PiggyBank = withId(Ph.PiggyBankIcon, "PiggyBank");
...
export const VideoCamera = withId(Ph.VideoCameraIcon, "VideoCamera");
...
export const TelegramLogo = withId(Ph.TelegramLogoIcon, "TelegramLogo");
...
export const TextAa = withId(Ph.TextAaIcon, "TextAa");
...
export const XCircle = withId(Ph.XCircleIcon, "XCircle");
