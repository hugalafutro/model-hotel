...
export function ModelDetailPanel({
	...
	const hasCustom = editable && hasAnyParam(params);
	...
	return (
		...
		>
				...
				<div className="flex items-center gap-0.5 shrink-0 ml-2">
					...
					{collapsible && (
						<CollapsibleToggle
							...
							iconStyle="double"
							expandTitle={t("components.modelDetailPanel.expandModelDetails")}
							collapseTitle={t(
								"components.modelDetailPanel.collapseModelDetails",
							)}
						/>
					)}
				</div>
			...
			<CollapseBody collapsed={collapsed && collapsible} className="px-2 py-2">
