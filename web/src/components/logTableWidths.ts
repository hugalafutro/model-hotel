...
export const LOG_COL_WIDTHS = [
	...
	{ key: "provider", width: "w-[9rem]" }, // "Anthropic Messages" / "Google AI Studio" fit; longer names truncate
...
/** Fitted columns sum to 80rem; the rest is the Model floor. The request
...
export const LOG_TABLE_MIN_W = "min-w-[86rem]";
