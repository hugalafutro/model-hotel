...
export const CHAT_PERSONAS: PersonaPreset[] = [
	...
	},
	{
		id: "madame-vex",
		icon: "🔮",
		label: "presets.personas.madame-vex",
	...
	},
	{
		id: "auntie-wei",
		icon: "🍵",
		label: "presets.personas.auntie-wei",
	...
	},
	{
		id: "unit-734",
		icon: "🤖",
		label: "presets.personas.unit-734",
	...
	},
	{
		id: "bramble",
		icon: "🌳",
		label: "presets.personas.bramble",
	...
	},
	{
		id: "dr-maren",
		icon: "🔭",
		label: "presets.personas.dr-maren",
	...
	},
	{
		id: "nonna-pia",
		icon: "🍝",
		label: "presets.personas.nonna-pia",
	...
	},
	{
		id: "whisper",
		icon: "🔤",
		label: "presets.personas.whisper",
...
export const ARENA_PROMPTS: ArenaPromptPreset[] = [
	...
	},
	{
		id: "blueprint",
		icon: "🏗️",
		label: "presets.prompts.blueprint",
	...
	},
	{
		id: "algorithm",
		icon: "💻",
		label: "presets.prompts.algorithm",
	...
	},
	{
		id: "integral",
		icon: "📐",
		label: "presets.prompts.integral",
	...
	},
	{
		id: "contract",
		icon: "📄",
		label: "presets.prompts.contract",
