...
// Compact Y-axis tick labels so large values (e.g. hundreds of millions)
// don't get clipped by the axis width — full-precision numbers like
// "100,000,000" overflow the default axis, worst in the monospace terminal
// theme. Tooltips keep the full value; only the axis is abbreviated.
function formatAxisTick(value: number, allowDecimals: boolean): string {
