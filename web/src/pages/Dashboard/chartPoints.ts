 ...
 * per bucket, labelled at the resolution the range implies. Latency is rounded
 * to whole milliseconds and the optional cache/TTFT fields fall back to 0, so
 * an absent value plots as a zero rather than a gap.
 */
