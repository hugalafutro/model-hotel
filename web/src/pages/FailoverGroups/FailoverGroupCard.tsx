				...
				<div className="flex items-center gap-1">
					{!group.auto_created && onEdit && (
						<button
							type="button"
							onClick={onEdit}
							className="ui-btn ui-btn-compact text-gray-500 hover:text-amber-400 hover:bg-white/5 transition-all"
						>
							{t("common.edit")}
						</button>
					)}
					<button
						type="button"
						onClick={() => onDelete()}
						className="ui-btn ui-btn-compact text-gray-500 hover:text-red-400 hover:bg-white/5 transition-all"
					>
						{t("common.delete")}
					</button>
				</div>
