...
describe("FailoverGroupCard", () => {
	...
	describe("Rendering", () => {
		...
		it("excludes effectively disabled entries from the active count", () => {
			const group = {
				...mockFailoverGroup,
				entries: [
					{
					...
					{
						// Entry toggle on, but the model was discovery-disabled:
						// the router skips it, so it must not count as active.
						model_uuid: "entry-2",
						model_id: "model-2",
						provider_id: "provider-2",
						provider_name: "Provider 2",
					...
					{
						// Entry toggle on, but the provider is disabled.
						model_uuid: "entry-3",
						model_id: "model-3",
