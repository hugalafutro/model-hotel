...
describe("useArenaState", () => {
	...
	it("returns all expected state values", () => {
		...
		// State values
		expect(result.current.compareModels).toBeDefined();
		expect(result.current.setCompareModels).toBeDefined();
		expect(result.current.bracketModels).toBeDefined();
		expect(result.current.setBracketModels).toBeDefined();
		expect(result.current.competitionActivePromptId).toBeDefined();
		expect(result.current.setCompetitionActivePromptId).toBeDefined();
		expect(result.current.compareActivePromptId).toBeDefined();
		expect(result.current.setCompareActivePromptId).toBeDefined();
		expect(result.current.competitionPrompt).toBeDefined();
		expect(result.current.setCompetitionPrompt).toBeDefined();
		expect(result.current.comparePrompt).toBeDefined();
		expect(result.current.setComparePrompt).toBeDefined();
		expect(result.current.prompt).toBeDefined();
		expect(result.current.setPrompt).toBeDefined();
		expect(result.current.activePromptId).toBeDefined();
		expect(result.current.setActivePromptId).toBeDefined();
		expect(result.current.savedPrompt).toBeDefined();
		expect(result.current.setSavedPrompt).toBeDefined();
		expect(result.current.comparePersonaId).toBeDefined();
		expect(result.current.setComparePersonaId).toBeDefined();
		expect(result.current.comparePersonaPrompt).toBeDefined();
		expect(result.current.setComparePersonaPrompt).toBeDefined();
		expect(result.current.rounds).toBeDefined();
		expect(result.current.setRounds).toBeDefined();
		expect(result.current.currentRound).toBeDefined();
		expect(result.current.setCurrentRound).toBeDefined();
		expect(result.current.phase).toBeDefined();
		expect(result.current.setPhase).toBeDefined();
		expect(result.current.runningModels).toBeDefined();
		expect(result.current.setRunningModels).toBeDefined();
		expect(result.current.winnerModal).toBeDefined();
		expect(result.current.setWinnerModal).toBeDefined();
		expect(result.current.disabledModels).toBeDefined();
		expect(result.current.setDisabledModels).toBeDefined();
		expect(result.current.arenaCollapsed).toBeDefined();
		expect(result.current.setArenaCollapsed).toBeDefined();
		expect(result.current.pendingFullReset).toBeDefined();
		expect(result.current.setPendingFullReset).toBeDefined();
		expect(result.current.showHistoryModal).toBeDefined();
		expect(result.current.setShowHistoryModal).toBeDefined();
		expect(result.current.modelParams).toBeDefined();
		expect(result.current.setModelParams).toBeDefined();
		expect(result.current.paramEditorModel).toBeDefined();
		expect(result.current.setParamEditorModel).toBeDefined();
		expect(result.current.arenaMode).toBeDefined();
		expect(result.current.setArenaMode).toBeDefined();

		// Refs
		expect(result.current.abortMapRef).toBeDefined();
		expect(result.current.lastExtractLenRef).toBeDefined();
		expect(result.current.currentRoundRef).toBeDefined();
		expect(result.current.roundsLengthRef).toBeDefined();
		...
		expect(result.current.disabledReason).toBeDefined();
		expect(result.current.buildCompareRoundWithParams).toBeDefined();
		expect(result.current.buildInitialRoundsWithParams).toBeDefined();
		expect(result.current.handleRandomComparePersona).toBeDefined();
		expect(result.current.handleRandomBracketModel).toBeDefined();
		expect(result.current.handleRandomCompareModel).toBeDefined();
		expect(result.current.previewPairs).toBeDefined();

		// Dependencies
		expect(result.current.enabledModels).toBeDefined();
