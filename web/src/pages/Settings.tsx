        ...
        <div className="space-y-8 max-w-5xl">
            <div>
                ...
                <p className="text-gray-400 mt-1">
                    Configure your LLM-Proxy instance
                </p>
            </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-500 text-xs mt-0.5">
                                    Run discovery for all providers when the
                                    server starts
                                </p>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-500 text-xs mt-0.5">
                                    Automatically discover models when a new
                                    provider is added
                                </p>
                            </div>
                            <button
                ...
                <div className="ui-card p-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <p
                                    className={`text-sm font-medium ${uiStyle === "cyber-terminal" ? "text-gray-500" : "text-gray-300"}`}
                                >
                                    Theme
                                </p>
                                <p className="text-gray-500 text-xs mt-0.5">
                                    {uiStyle === "cyber-terminal"
                                        ? "Cyber Terminal is dark only"
                                        : "Switch between dark and light mode"}
                                </p>
                            </div>
                            <div
                                className={`flex rounded-lg overflow-hidden border ${uiStyle === "cyber-terminal" ? "border-gray-700 opacity-60" : "border-gray-600"}`}
                            >
                                <button
                                    type="button"
