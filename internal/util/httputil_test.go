...
func TestBuildProviderTargetURL(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "NanoGPT subscription base drops /subscription for image generations",
			baseURL:      "https://nano-gpt.com/api/subscription/v1",
			providerType: "nanogpt",
			endpoint:     "/images/generations",
			expected:     "https://nano-gpt.com/api/v1/images/generations",
		},
		{
			name:         "NanoGPT subscription base drops /subscription for image edits",
			baseURL:      "https://nano-gpt.com/api/subscription/v1",
			providerType: "nanogpt",
			endpoint:     "/images/edits",
			expected:     "https://nano-gpt.com/api/v1/images/edits",
		},
		{
			name:         "NanoGPT non-subscription base is unchanged for image generations",
			baseURL:      "https://api.nano-gpt.com/v1",
			providerType: "nanogpt",
			endpoint:     "/images/generations",
			expected:     "https://api.nano-gpt.com/v1/images/generations",
		},
		{
			name:         "NanoGPT subscription base keeps /subscription for chat completions",
			baseURL:      "https://nano-gpt.com/api/subscription/v1",
			providerType: "nanogpt",
			endpoint:     "/chat/completions",
			expected:     "https://nano-gpt.com/api/subscription/v1/chat/completions",
		},
		{
