...
func TestAppendLogFilters_NoFilters(t *testing.T) {
	query, args, idx := appendLogFilters("SELECT * FROM t WHERE 1=1", nil, 1, logFilters{})
...
func TestAppendLogFilters_ModelID(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{modelID: "gpt-4"})
...
func TestAppendLogFilters_ProviderID_ValidUUID(t *testing.T) {
	validUUID := uuid.New().String()
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{providerID: validUUID})
...
func TestAppendLogFilters_ProviderID_InvalidUUID(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{providerID: "not-a-uuid"})
...
func TestAppendLogFilters_StatusCode4xx(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{statusCode: "4xx"})
...
func TestAppendLogFilters_StatusCode5xx(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{statusCode: "5xx"})
...
func TestAppendLogFilters_StatusCodeSpecific(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{statusCode: "404"})
...
func TestAppendLogFilters_StatusCodeZero(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{statusCode: "0"})
...
func TestAppendLogFilters_StatusCodeNegative(t *testing.T) {
	query, args, _ := appendLogFilters("WHERE 1=1", nil, 1, logFilters{statusCode: "-1"})
...
func TestAppendLogFilters_StatusCodeNonNumeric(t *testing.T) {
	query, args, _ := appendLogFilters("WHERE 1=1", nil, 1, logFilters{statusCode: "abc"})
	if strings.Contains(query, "status_code") {
...
func TestAppendLogFilters_FromDate(t *testing.T) {
	...
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{fromDate: from})
...
func TestAppendLogFilters_ToDate(t *testing.T) {
	...
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{toDate: to})
	if !strings.Contains(query, "AND rl.created_at <= $1") {
...
func TestAppendLogFilters_InvalidFromDate(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{fromDate: "not-a-date"})
...
func TestAppendLogFilters_InvalidToDate(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{toDate: "garbage"})
	if strings.Contains(query, "rl.created_at <=") {
...
func TestAppendLogFilters_AllFilters(t *testing.T) {
	validUUID := uuid.New().String()
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 3, logFilters{modelID: "gpt-4", providerID: validUUID, statusCode: "404", fromDate: "2024-01-01T00:00:00Z", toDate: "2024-12-31T23:59:59Z"})
...
func TestAppendLogFilters_EndpointType(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{endpointType: "embeddings"})
	if !strings.Contains(query, "AND COALESCE(rl.endpoint_type, 'chat') = $1") {
		t.Errorf("expected endpoint_type filter at $1, got %q", query)
	}
	if len(args) != 1 || args[0] != "embeddings" {
		t.Errorf("expected args=[embeddings], got %v", args)
	}
	if idx != 2 {
		t.Errorf("expected argIdx=2, got %d", idx)
	}
...
func TestAppendLogFilters_EndpointTypeInvalidIgnored(t *testing.T) {
	query, args, idx := appendLogFilters("WHERE 1=1", nil, 1, logFilters{endpointType: "bogus"})
...
// isValidEndpointType reads endpointtype.All(), so a test that ranged over that
...
func TestIsValidEndpointType(t *testing.T) {
	...
	for _, v := range []string{"", "images", "CHAT", "speech", "bogus"} {
		if isValidEndpointType(v) {
			t.Errorf("isValidEndpointType(%q) = true, want false", v)
		}
	}
}
