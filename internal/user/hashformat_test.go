...
func TestValidateHashFormat_RejectsMalformed(t *testing.T) {
	cases := []struct {
		...
		{"wrong part count", "$argon2id$m=19456,t=2,p=1$c29tZXNhbHQ$c29tZWtleQ"},
		{"wrong argon2 version", "$argon2id$v=18$m=19456,t=2,p=1$c29tZXNhbHQ$c29tZWtleQ"},
		{"iterations above the ceiling", "$argon2id$v=19$m=19456,t=31,p=1$c29tZXNhbHQ$c29tZWtleQ"},
		{"threads above the ceiling", "$argon2id$v=19$m=19456,t=2,p=65$c29tZXNhbHQ$c29tZWtleQ"},
		{"non-base64 key", "$argon2id$v=19$m=19456,t=2,p=1$c29tZXNhbHQ$not!base64"},
